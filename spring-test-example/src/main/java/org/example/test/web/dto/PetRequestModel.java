...
public class PetRequestModel {
    ...
    //private PetRequestModel(){ }

    public PetRequestModel(String name, String owner, String species, Pet.Sex sex, LocalDate birth, LocalDate death) {
        this.name = name;
        this.owner = owner;
    ...
    public String toString() {
        return String.format("PetRequestModel(name = %s, owner = %s, species = %s, sex = %s, birth = %s, death = %s)", name, owner, species, sex, birth, death);
    }
    ...
    public static class PetRequestBuilder {
        ...
        @Override
        public String toString() {
            return String.format("PetRequestModelBuilder(name = %s, owner = %s, species = %s, sex = %s, birth = %s, death = %s)", name, owner, species, sex, birth, death);
        }

        public PetRequestModel build() {
//            return new PetRequestModel();
            return new PetRequestModel(name, owner, species, sex, birth, death);
        }
    }
}
